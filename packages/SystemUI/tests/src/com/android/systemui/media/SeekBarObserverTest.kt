...
public class SeekBarObserverTest : SysuiTestCase() {
    ...
    fun seekBarGone() {
        ...
        val isEnabled = false
        val data = SeekBarViewModel.Progress(isEnabled, false, null, 0, null)
    ...
    fun seekBarProgress() {
        ...
        val data = SeekBarViewModel.Progress(true, true, 3000, 120000, -10)
        observer.onChanged(data)
    ...
    fun seekBarDisabledWhenSeekNotAvailable() {
        ...
        val data = SeekBarViewModel.Progress(true, isSeekAvailable, 3000, 12000, -10)
        observer.onChanged(data)
